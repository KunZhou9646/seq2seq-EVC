...
#    i = i + 1
eval_dir = '/home/zhoukun/nonparaSeq2seqVC_code-master/0013/mel/Evaluation'
train_dir = '/home/zhoukun/nonparaSeq2seqVC_code-master/0013/mel/Training'
test_dir = '/home/zhoukun/nonparaSeq2seqVC_code-master/0013/mel/Test'
eval_list = []
train_list = []
test_list = []
...
for file in eval_list:
    ...
    file_phone = os.path.join('/home/zhoukun/nonparaSeq2seqVC_code-master/0013/txt',b)
...
f = open('./emotion_list/evaluation_mel_list.txt','w')
...
f = open('./emotion_list/testing_mel_list.txt','w')
for index in range(len(file_list)):
    f.write(str(file_list[index]) + ' ' + str(num_frame_list[index]) + '\n')
f.close()
file_list = []
...
f = open('./emotion_list/training_mel_list.txt','w')
for index in range(len(file_list)):
    f.write(str(file_list[index]) + ' ' + str(num_frame_list[index])  + '\n')
f.close()
